...
static struct hpo_hdmi_stream_encoder *dcn36_hpo_hdmi_stream_encoder_create(
	enum engine_id eng_id,
	struct dc_context *ctx)
{
...
static struct hpo_hdmi_link_encoder *dcn36_hpo_hdmi_link_encoder_create(
	uint8_t inst,
	struct dc_context *ctx)
{
...
static const struct resource_create_funcs res_create_funcs = {
	...
	.create_hpo_hdmi_stream_encoder = dcn36_hpo_hdmi_stream_encoder_create,
	.create_hpo_hdmi_link_encoder = dcn36_hpo_hdmi_link_encoder_create,
